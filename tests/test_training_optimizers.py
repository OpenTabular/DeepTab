...
class TestNormalizeOptimizerKwargs:
    ...
    def test_unprefixed_keys_pass_through(self):
        """Regression test (GH-415): TrainerConfig.optimizer_kwargs uses unprefixed keys.

        These were previously filtered out entirely, so user optimizer settings
    ...
    def test_trainer_config_optimizer_kwargs_reach_the_optimizer(self):
        """End-to-end regression test (GH-415) for the TrainerConfig path."""
