...
from deeptab.nn.blocks.mamba import MambAttn
...
class MambAttention(BaseModel):
    ...
    **kwargs : dict
    ...
    def __init__(
        ...
        num_classes=1,
        config: MambAttentionConfig = MambAttentionConfig(),  # noqa: B008
        **kwargs,
    ):
